    ...
    <section style={{ maxWidth: 960, margin: '0 auto', padding: '40px 56px 64px' }}>
      ...
      <div style={{ marginTop: 24, display: 'grid', gap: 20 }}>
        ...
        <div>
          ...
          <p style={bodyStyle}>To request account deletion and purging of your collection data, contact <a href="mailto:support@virtualwatchbox.com" style={{ color: brand.colors.goldDeep }}>support@virtualwatchbox.com</a> from your account email.</p>
        </div>
      </div>
    </section>
  )
