...
const UpgradeRow = ({ u }) =>
  React.createElement('article', {
    ...
    u.aspirational && React.createElement('div', {
      style: {
        position: 'absolute', top: 24, right: 28,
        fontFamily: ES.sans, fontSize: 9, fontWeight: 600,
        letterSpacing: '0.16em', textTransform: 'uppercase',
        color: ES.gold, padding: '4px 10px',
        border: `1px solid ${ES.gold}`, borderRadius: 20,
        background: 'rgba(201,168,76,0.06)', zIndex: 2,
      }
    }, 'Stretch'),

    // From → To pair, large images
    React.createElement('div', { className: 'vwb-upgrade-pair', style: {
      ...
      React.createElement('div', { style: { textAlign: 'center' } },
        React.createElement('div', { style: {
          background: ES.paper, aspectRatio: '1', padding: 24,
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          marginBottom: 14, border: `1px solid ${ES.border}`,
        } },
          React.createElement('img', { src: u.from.image, alt: u.from.model,
            style: {
              maxWidth: '100%', maxHeight: '100%', objectFit: 'contain',
              filter: 'drop-shadow(0 10px 18px rgba(26,20,16,0.16))',
            } })
        ),
        React.createElement(Kicker, { color: ES.muted, style: { fontSize: 9, marginBottom: 4 } }, 'You own'),
        React.createElement('div', { style: {
          fontFamily: ES.serif, fontSize: 19, lineHeight: 1.1, color: ES.ink,
        } }, u.from.model),
        React.createElement('div', { style: {
          fontFamily: ES.sans, fontSize: 11, color: ES.muted, marginTop: 3, letterSpacing: '0.04em',
      ...
      React.createElement('div', { className: 'vwb-upgrade-arrow', style: {
        ...
        React.createElement(GoldArrow, { size: 36 }),
        React.createElement(Kicker, { color: ES.muted, style: { fontSize: 8.5, marginTop: 4 } }, 'Step up'),
      ),
      ...
      React.createElement('div', { style: { textAlign: 'center' } },
        React.createElement('div', { style: {
          background: ES.paper, aspectRatio: '1', padding: 24,
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          marginBottom: 14, border: `1px solid ${ES.gold}`,
          boxShadow: 'inset 0 0 0 1px rgba(201,168,76,0.2)',
        } },
          React.createElement('img', { src: u.to.image, alt: u.to.model,
            style: {
              maxWidth: '100%', maxHeight: '100%', objectFit: 'contain',
              filter: 'drop-shadow(0 12px 22px rgba(26,20,16,0.20))',
            } })
        ),
        React.createElement(Kicker, { color: ES.gold, style: { fontSize: 9, marginBottom: 4 } }, 'Consider'),
        React.createElement('div', { style: {
          fontFamily: ES.serif, fontStyle: 'italic', fontSize: 19, lineHeight: 1.1, color: ES.ink,
        } }, u.to.model),
        React.createElement('div', { style: {
          fontFamily: ES.sans, fontSize: 11, color: ES.muted, marginTop: 3, letterSpacing: '0.04em',
