...
const PLAYGROUND_WATCHES = [
  {
    id: 'patek-5711', brand: 'Patek Philippe', model: 'Nautilus',
    reference: '5711/1A-010', caseSizeMm: 40, caseMaterial: 'Stainless Steel',
    dialColor: 'Blue Horizontal', movement: 'Cal. 324 S C (Auto)', complications: ['Date'],
    condition: 'Excellent', purchaseDate: '', purchasePrice: 0,
    estimatedValue: 120000, notes: '',
    imageUrl: null,
    dialConfig: { dialColor: '#1B3A6A', markerColor: '#FAF8F4', handColor: '#FAF8F4' },
    watchType: 'Integrated Bracelet', ownershipStatus: 'Owned',
  },
  {
    id: 'ap-15500', brand: 'Audemars Piguet', model: 'Royal Oak',
    reference: '15500ST.OO.1220ST.01', caseSizeMm: 41, caseMaterial: 'Stainless Steel',
    dialColor: 'Blue Tapisserie', movement: 'Cal. 4302 (Auto)', complications: ['Date'],
    condition: 'Excellent', purchaseDate: '', purchasePrice: 0,
    estimatedValue: 45000, notes: '',
    imageUrl: null,
    dialConfig: { dialColor: '#2A4A8A', markerColor: '#FAF8F4', handColor: '#FAF8F4' },
    watchType: 'Integrated Bracelet', ownershipStatus: 'Owned',
  },
  {
    id: 'rolex-daytona', brand: 'Rolex', model: 'Cosmograph Daytona',
    reference: '116500LN', caseSizeMm: 40, caseMaterial: 'Stainless Steel',
    dialColor: 'Black Ceramic', movement: 'Cal. 4130 (Auto)', complications: ['Chronograph'],
    condition: 'Unworn', purchaseDate: '', purchasePrice: 0,
    estimatedValue: 32000, notes: '',
    imageUrl: null,
    dialConfig: { dialColor: '#111111', markerColor: '#FAF8F4', handColor: '#FAF8F4' },
    watchType: 'Chronograph', ownershipStatus: 'Owned',
  },
  {
    id: 'grand-seiko-snowflake', brand: 'Grand Seiko', model: 'Snowflake',
    reference: 'SBGA211', caseSizeMm: 41, caseMaterial: 'Titanium',
    dialColor: 'White Snowflake', movement: '9R65 (Spring Drive)', complications: ['Date'],
    condition: 'Like New', purchaseDate: '', purchasePrice: 0,
    estimatedValue: 5200, notes: '',
    imageUrl: null,
    dialConfig: { dialColor: '#E8E8E8', markerColor: '#2A2520', handColor: '#2A2520' },
    watchType: 'Dress', ownershipStatus: 'Owned',
  },
];
...
Object.assign(window, { fmt, WATCHES, PLAYGROUND_WATCHES, STATUS_STYLES, CONDITION_STYLES, DialSVG });
